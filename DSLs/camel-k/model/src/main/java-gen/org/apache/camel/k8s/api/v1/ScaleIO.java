...
public class ScaleIO implements KubernetesResource
{
     ...
     * @param gateway
     */
    public ScaleIO(String fsType, String gateway, String protectionDomain, Boolean readOnly, SecretRef secretRef, Boolean sslEnabled, String storageMode, String storagePool, String system, String volumeName) {
        super();
        this.fsType = fsType;
