...
public class PodAntiAffinity implements KubernetesResource
{
     ...
     */
    public PodAntiAffinity(List<PreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution, List<RequiredDuringSchedulingIgnoredDuringExecution> requiredDuringSchedulingIgnoredDuringExecution) {
        super();
